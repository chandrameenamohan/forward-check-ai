...
function makeClassifierResult(
  ...
  return {
    ...
    extractedClaim: "PM Modi announced Rs 5000 transfer",
    isCompound: false,
    domain: "geopolitics",
    language: "en",
    urgency: "high",
    reasoning: "This is a factual claim about government policy.",
    ...overrides,
  };
}

function makeSearchStrategy(
  ...
  return {
    ...
    investigatorGuidance: {
      sourceVerification: {
        targetQueries: ["Modi Rs 5000 transfer official", "PIB press release"],
        prioritySources: ["pib.gov.in"],
        lookFor: "Official government press releases",
      },
      domainExpertise: {
        targetQueries: ["India direct benefit transfer scheme", "Modi cash transfer"],
        prioritySources: ["rbi.org.in"],
        lookFor: "RBI or finance ministry announcements",
      },
      patternMatching: {
        targetQueries: ["Modi Rs 5000 fake", "Modi transfer fact check"],
        prioritySources: ["altnews.in", "boomlive.in"],
        lookFor: "Existing fact checks",
      },
    },
    falsificationCriteria: {
      whatWouldProveTrue: ["Official PIB press release"],
      whatWouldProveFalse: ["No official government announcement found"],
    },
    thinkingExcerpt: "Thinking about the claim...",
    ...overrides,
  };
}
...
function makeAgentReport(
  ...
  return {
    ...
    summary: "No official sources confirm this claim.",
    findings: [
      {
        claim: "Modi announced Rs 5000 transfer",
        ...
        sources: [
          {
            ...
            title: "PIB Official",
            credibility: "high",
            relevantSnippet: "No such announcement found",
          },
        ],
      },
    ],
    overallAssessment: "Claim appears to be fabricated.",
    confidenceScore: 20,
    ...overrides,
  };
}
    ...
    challenges: [
      {
        ...
        challenge: "Could there be regional announcements not indexed?",
        severity: "minor",
        evidence: "Some state-level announcements are poorly indexed.",
      },
    ],
    overallAssessment: "Investigator consensus is strong.",
    suggestedConfidenceAdjustment: -5,
    counterArgumentSucceeded: false,
    counterArgumentSummary: "Counter-argument failed. Investigators found strong evidence.",
    thinkingExcerpt: "DA thinking excerpt...",
    ...overrides,
  };
}

function makeFinalVerdict(
  ...
  return {
    ...
    summary: "No official sources support this claim.",
    ...
    keyFindings: ["No PIB press release found"],
    sources: [{ url: "https://pib.gov.in", title: "PIB", relevance: "Primary" }],
    whatWouldChangeMyMind: "An official PIB press release",
